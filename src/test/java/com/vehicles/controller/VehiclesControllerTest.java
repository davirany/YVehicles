...
class VehiclesControllerTest {
    ...
    @Test
    void listByPrice() {
        Brand brand1 = new Brand("Chevrolet", "American", 1911);
        ...
        Brand brand2 = new Brand("Chevrolet", "American", 1911);
        ...
        Brand brand3 = new Brand("Chevrolet", "American", 1911);
